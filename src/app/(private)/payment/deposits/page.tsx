...
const DepositsPage = () => {
  ...
  const { data, isLoading, isFetching } = useFetchDepositsQuery(filter);
  ...
  const findPaymentWallets = () => {
    ...
    for (let i = 0; i < deposits?.length; i++) {
      if (
        ...
        wallets.push({
          walletName: deposits[i].ewallet.walletName,
          walletImage: deposits[i].ewallet.walletImage,
        });
      }
    }
                ...
                <TableRow key={deposit.id} className="">
                  ...
                  <TableCell>
                    <div className="flex items-center capitalize">
                      <img
                        src={deposit.ewallet.walletImage}
                        alt={deposit.ewallet.walletName}
                      ...
                      <div>
                        ...
                        <div className=" p-4 rounded-lg space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm font-medium">
                              {selectedDeposit.ewallet.walletName}{" "}
                              <img
                                src={selectedDeposit.ewallet.walletImage}
                                alt={selectedDeposit.ewallet.walletName}
                                className="w-[50px]"
                              />
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm font-medium">
                              {selectedDeposit.ewallet.walletNumber}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  {selectedDeposit?.status === "PENDING" ? (
                    <>
                      ...
                      <Button
                        disabled={arrovalActionLoading}
                        onClick={() =>
                          handleArroval(selectedDeposit.id, "accept")
                        }
